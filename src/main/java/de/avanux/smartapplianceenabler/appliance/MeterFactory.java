...
public class MeterFactory {
    ...
    public Meter getMeter(ApplianceConfiguration configuration) {
        if(configuration.getS0ElectricityMeters() != null && configuration.getS0ElectricityMeters().size() > 0) {
            S0ElectricityMeter s0ElectricityMeter = configuration.getS0ElectricityMeters().get(0);
