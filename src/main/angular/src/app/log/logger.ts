 ...
 * See {@link Logger}.
 *
 * level - How much detail you want to see in the logs, 0 being off, 1 being the less detailed,
 *         5 being the most. Defaults to WARN.
 ...
 * store - Whether you want the level config to be saved in the local storage so it doesn't get lost when you refresh.
 *         Defaults to false.
...
export class Logger {
  ...
  constructor( @Optional() options?: Options ) {
    ...
    // Move this to the constructor definition when optional parameters are working with
    // @Injectable: https://github.com/angular/angular/issues/7344
  ...
  error2(message?: any, ...optionalParams: any[]) {
  ...
  warn2(message?: any, ...optionalParams: any[]) {
    this.isWarnEnabled() && console.warn.bind( console, arguments );
  }
  ...
  info2(message?: any, ...optionalParams: any[]) {
  ...
  debug2(message?: any, ...optionalParams: any[]) {
  ...
  log2(message?: any, ...optionalParams: any[]) {
