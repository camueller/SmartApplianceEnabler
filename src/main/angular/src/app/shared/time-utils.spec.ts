...
describe('TimeUtil', () => {
  ...
  describe('toHourMinuteWithUnits', () => {
    ...
    it('display 1 second', () => {
      expect(TimeUtil.toHourMinuteWithUnits(1)).toEqual('0h 0min');
    });
    it('display 59 seconds', () => {
      expect(TimeUtil.toHourMinuteWithUnits(59)).toEqual('0h 0min');
    });
    it('display 60 seconds', () => {
      expect(TimeUtil.toHourMinuteWithUnits(60)).toEqual('0h 1min');
    });
    it('display 61 seconds', () => {
      expect(TimeUtil.toHourMinuteWithUnits(61)).toEqual('0h 1min');
    });
    it('display 3599 seconds', () => {
      expect(TimeUtil.toHourMinuteWithUnits(3599)).toEqual('0h 59min');
    });
    ...
    it('display 86399 seconds', () => {
      expect(TimeUtil.toHourMinuteWithUnits(86399)).toEqual('23h 59min');
    });
    it('display 86400 seconds', () => {
      expect(TimeUtil.toHourMinuteWithUnits(86400)).toEqual('1d 0h 0min');
    });
    it('display 86401 seconds', () => {
      expect(TimeUtil.toHourMinuteWithUnits(86401)).toEqual('1d 0h 0min');
    });
  });
