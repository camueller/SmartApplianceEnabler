...
public class DayTimeframeTest extends TestBase {
    ...
    public void getIntervals_AllDayOfWeek_BeforeIntervalStart() {
        ...
        assertEquals(new Interval(toToday(10, 0, 0), toToday(12, 0, 0)), intervals.get(0).getInterval());
        assertEquals(new Interval(toDay(1, 10, 0, 0), toDay(1, 12, 0, 0)), intervals.get(1).getInterval());
        assertEquals(new Interval(toDay(2, 10, 0, 0), toDay(2, 12, 0, 0)), intervals.get(2).getInterval());
        assertEquals(new Interval(toDay(3, 10, 0, 0), toDay(3, 12, 0, 0)), intervals.get(3).getInterval());
        assertEquals(new Interval(toDay(4, 10, 0, 0), toDay(4, 12, 0, 0)), intervals.get(4).getInterval());
        assertEquals(new Interval(toDay(5, 10, 0, 0), toDay(5, 12, 0, 0)), intervals.get(5).getInterval());
        assertEquals(new Interval(toDay(6, 10, 0, 0), toDay(6, 12, 0, 0)), intervals.get(6).getInterval());
    }
    ...
    public void getIntervals_AllDayOfWeek_AfterIntervalEnd() {
        ...
        assertEquals(7, intervals.size());
        assertEquals(new Interval(toDay(1, 10, 0, 0), toDay(1, 12, 0, 0)), intervals.get(0).getInterval());
        assertEquals(new Interval(toDay(2, 10, 0, 0), toDay(2, 12, 0, 0)), intervals.get(1).getInterval());
        assertEquals(new Interval(toDay(3, 10, 0, 0), toDay(3, 12, 0, 0)), intervals.get(2).getInterval());
        assertEquals(new Interval(toDay(4, 10, 0, 0), toDay(4, 12, 0, 0)), intervals.get(3).getInterval());
        assertEquals(new Interval(toDay(5, 10, 0, 0), toDay(5, 12, 0, 0)), intervals.get(4).getInterval());
        assertEquals(new Interval(toDay(6, 10, 0, 0), toDay(6, 12, 0, 0)), intervals.get(5).getInterval());
        assertEquals(new Interval(toDay(7, 10, 0, 0), toDay(7, 12, 0, 0)), intervals.get(6).getInterval());
    }
    ...
    public void getIntervals_DayOfWeekNotMatching_BeforeIntervalStart() {
        ...
        assertEquals(new Interval(toDayOfWeek(now, 3, 10, 0, 0), toDayOfWeek(now, 3, 12, 0, 0)), intervals.get(0).getInterval());
    }
    ...
    public void getIntervals_ValidOnlyOnHoliday_HolidaySet() {
        ...
        List<TimeframeInterval> intervals = timeframe.getIntervals(now);
        assertEquals(1, intervals.size());
        assertEquals(new Interval(toDayOfWeek(now, 1, 10, 0, 0), toDayOfWeek(now, 1, 12, 0, 0)), intervals.get(0).getInterval());
    }
    ...
    public void getIntervals_ValidOnSundayAndHoliday_HolidayIsSunday() {
        ...
        List<TimeframeInterval> intervals = timeframe.getIntervals(now);
        assertEquals(1, intervals.size());
        assertEquals(new Interval(toDayOfWeek(now, 7, 10, 0, 0), toDayOfWeek(now, 7, 12, 0, 0)), intervals.get(0).getInterval());
    }
    ...
    public void getIntervals_ValidOnSundayAndHoliday_HolidayIsThursday() {
        ...
        assertEquals(new Interval(toDayOfWeek(now, 4, 10, 0, 0), toDayOfWeek(now, 4, 12, 0, 0)), intervals.get(0).getInterval());
        assertEquals(new Interval(toDayOfWeek(now, 7, 10, 0, 0), toDayOfWeek(now, 7, 12, 0, 0)), intervals.get(1).getInterval());
    }
    ...
    public void buildMidnightAdjustedInterval_NotOverMidnight() {
        ...
        assertEquals(new Interval(toToday(22, 0, 0), toToday(23, 0, 0)), interval);
    }
    ...
    public void buildMidnightAdjustedInterval_OverMidnight_BeforeInterval_BeforeMidnight() {
        ...
        assertEquals(new Interval(toToday(22, 0, 0), toDay(1, 2, 0, 0)), interval);
    }
    ...
    public void buildMidnightAdjustedInterval_OverMidnight_WithinInterval_AfterMidnight() {
        ...
        assertEquals(new Interval(toDay(-1, 22, 0, 0), toToday(2, 0, 0)), interval);
    }
