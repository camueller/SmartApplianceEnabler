...
# Overview
**The *Smart Appliance Enabler* is a software for integrating any device ([Wallbox](doc/EVCharger_DE.md), heat pump, washing machine, dishwasher, ...) with the [Sunny Home Manager](https://www.sma.de/produkte/monitoring-control/sunny-home-manager-20.html) by [SMA](http://www.sma.de) to **maximize the use of self-generated electricity obtained by photovoltaic systems**.**
...
| Protocol | Products                                                                                                                                                                                                                                              |
|---------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| GPIO          | [S0 meter](doc/S0Meter_DE.md)                                                                                                                                                                                                                         |
| Modbus        | [Modbus meter](doc/ModbusMeter_DE.md)                                                                                                                                                                                                                 |
| HTTP          | [HTTP meter](doc/HttpMeter_DE.md) in general<ul></ul>compatible products<ul><li>[Shelly Plug/3EM/4PM/Plus 1PM](doc/Shelly_DE.md)</li><li>[Edimax SP-2101W](doc/EdimaxSP2101W_DE.md)</li></ul>all products using [Tasmota](doc/Tasmota_DE.md) firmware |

[More details about these meters and other software based meters (e.g. master/slave meter)](doc/Meter_DE.md)
...
| Protocol | Products                                                                                                                                                                                                                                                                                                                                 |
| ------------- |------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| GPIO | [GPIO switch](doc/GPIOSwitch_DE.md)<br>[level switch](doc/LevelSwitch_DE.md)<br>[PWM switch](doc/PwmSwitch_DE.md)                                                                                                                                                                                                                        |
| Modbus | [Modbus switch](doc/ModbusSwitch_DE.md)<br>[level switch](doc/LevelSwitch_DE.md)<br><br>[wallbox](doc/EVCharger_DE.md)                                                                                                                                                                                                                   |
| HTTP | [HTTP switch](doc/HttpSwitch_DE.md)<br>[level switch](doc/LevelSwitch_DE.md)<ul></ul>compatible products<ul><li>[Shelly Plug/4PM](doc/Shelly_DE.md)</li><li>[Edimax SP-2101W](doc/EdimaxSP2101W_DE.md)</li></ul>all products using [Tasmota](doc/Tasmota_DE.md) firmware<ul></ul>[wallbox](doc/EVCharger_DE.md) |

[More details about these switches and other software based switches (e.g. starting current detection, "smart grid ready" support of heat pumps)](doc/Control_DE.md)

# Assembly

If the *Smart Appliance Enabler* is to be operated on a Raspberry Pi, the [Assembly Instructions](doc/Assembly_DE.md) should be observed.

# Installation / Update

The [standard installation](doc/Installation_DE.md) runs automatically and requires no Linux knowledge.

If necessary, the [manual installation](doc/ManualInstallation_DE.md) can also be selected as an alternative, in which all commands in the documentation must be executed manually.

[Installing updates](doc/Update_DE.md) enables the use of new functions and bug fixes.

<a href="doc/Docker_DE.md"><img align="left" src="pics/Docker.png"></a>If desired, the *Smart Appliance Enabler* can also be operated in a container with the provided [Docker-Images](doc/Docker_DE.md).<br><br>

# Configuration and Control

The [configuration](doc/Configuration_DE.md) of the *Smart Appliance Enabler* is done with the **web browser**.

The status of all controllable devices is clearly displayed in the [Status display](doc/Status_DE.md), whereby the status of each device is visualized by a **traffic light**. The traffic light can also be used for **manual control**.

<a><img align="left" src="pics/mqtt-logo.png"></a>
In addition, the *Smart Appliance Enabler* supports [Node-RED by exporting flows for the configured devices so that they can be visualized in the Node-RED dashboard](doc/NodeRED_DE.md). In addition, MQTT can be used to integrate the *Smart Appliance Enabler* with other automation platforms.
...
In addition, I offer [personal, individual, fee-based support with advice](doc/Support_DE.md) - so to speak, the "all-round carefree package".
<br><br><br>

# Contribute
<a href="doc/Contribute_DE.md"><img align="left" src="pics/IWantYou.png"></a>
To [contribute](doc/Contribute_DE.md) you **don't have to be a programmer**! **Anyone** can [contribute](doc/Contribute_DE.md) in many different ways! [Your application scenarios for the *Smart Appliance Enabler*](doc/ApplicationScenarios_DE.md) help others!
<br><br><br><br><br><br>
