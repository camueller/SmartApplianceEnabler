...
<p align="center">
  ...
  <p align="center">
    <a href="https://github.com/camueller/SmartApplianceEnabler/releases/download/2.2.2/SmartApplianceEnabler-2.2.2.war">
      <img src="https://img.shields.io/badge/Download-2.2.2-brightgreen.svg">
    </a>
    <a href="https://hub.docker.com/repository/docker/avanux/smartapplianceenabler">
      <img src="https://img.shields.io/badge/Docker-2.2.2-blue">
    </a>
...
| HTTP       | [HTT Schalter](doc/HttpSwitch_DE.md)<br>[HTTP-basierte Stufenschalter](doc/LevelSwitch_DE.md)<ul></ul>kompatible Produkte<ul><li>[Shelly Plug/4PM](doc/Shelly_DE.md)</li><li>[Edimax SP-2101W](doc/EdimaxSP2101W_DE.md)</li></ul>alle Produkte mit [Tasmota](doc/Tasmota_DE.md)-Firmware<ul></ul>[Wallboxen](doc/EVCharger_DE.md) |
