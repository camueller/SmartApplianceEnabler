...
Der Aufbau zum Messen des Stromverbrauchs eines 240V-Gerätes (z.B. Pumpe) könnte wie folgt aussehen. Dabei kann diese Schaltung natürlich um einen Schalter erweitert werden, wenn neben dem Messen auch geschaltet werden soll.
