...
The figure below shows the configuration of a level switch for a [heating rod whose power consumption is between 0.5 kW and 3.5 kW in steps of 0.5 kW](https://www.killus-technik.de/de/power-to-heat/photovoltaik-heizelemente/photovoltaik-vario-heizer-0-5-3-5-kw-mit-regler-begrenzer-2399.html) can be controlled:
