...
Damit das Zeitangaben zum Schalten der Geräte richtig interpretiert werden, solle die Zeitzone des Raspberry auf die lokale Zeit gesetzt sein (nicht UTC!). Das kann mit folgendende Befehlen erreicht werden:
```
